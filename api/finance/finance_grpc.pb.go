...
const (
	...
	FinanceService_GetIncomesForPeriod_FullMethodName = "/finance.FinanceService/GetIncomesForPeriod"
)
...
type FinanceServiceClient interface {
	...
	GetIncomesForPeriod(ctx context.Context, in *GetIncomesForPeriodRequest, opts ...grpc.CallOption) (*GetIncomesForPeriodResponse, error)
}
...
func (c *financeServiceClient) GetIncomesForPeriod(ctx context.Context, in *GetIncomesForPeriodRequest, opts ...grpc.CallOption) (*GetIncomesForPeriodResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetIncomesForPeriodResponse)
	err := c.cc.Invoke(ctx, FinanceService_GetIncomesForPeriod_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FinanceServiceServer interface {
	...
	GetIncomesForPeriod(context.Context, *GetIncomesForPeriodRequest) (*GetIncomesForPeriodResponse, error)
...
func (UnimplementedFinanceServiceServer) GetIncomesForPeriod(context.Context, *GetIncomesForPeriodRequest) (*GetIncomesForPeriodResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetIncomesForPeriod not implemented")
}
...
func _FinanceService_GetIncomesForPeriod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetIncomesForPeriodRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FinanceServiceServer).GetIncomesForPeriod(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FinanceService_GetIncomesForPeriod_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FinanceServiceServer).GetIncomesForPeriod(ctx, req.(*GetIncomesForPeriodRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FinanceService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetIncomesForPeriod",
			Handler:    _FinanceService_GetIncomesForPeriod_Handler,
		},
	},
